...
defmodule AdventOfCodeDay2Test do
  ...
  test "part 1 works with sample data" do
    assert AdventOfCodeDay2.part1(:sample) == 7
  end

  @tag :skip
  test "part 2 works with real data" do
    assert AdventOfCodeDay2.part1(:actual) == 1393
  end

  @tag :skip
  test "part 2 works with sample data" do
    assert AdventOfCodeDay2.part2(:sample) == 5
  end

  @tag :skip
  test "part 2 works with real data" do
    assert AdventOfCodeDay2.part2(:actual) == 1359
  end
end
